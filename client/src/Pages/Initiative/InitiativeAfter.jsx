...
const InitiationAfter = () => {
  const initiatives = [
    {
      imageUrl: "https://images.unsplash.com/photo-1421789665209-c9b2a435e3dc?q=80&w=2671&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      name: "Initiative 1",
      theme: "Theme 1",
      date: "2024-02-01",
      volunteers: 10,
    ...
    {
      imageUrl: "https://media.istockphoto.com/id/1395715490/photo/happy-smiling-kid-holding-save-environment-sign-board-while-other-kids-cleaning-around-at.webp?b=1&s=170667a&w=0&k=20&c=_84v8o23Gf3p1YQxJj0JWjbRzlf7VeRqNXhP-nJF2x8=",
      name: "Initiative 2",
      theme: "Theme 2",
      date: "2024-02-05",
      volunteers: 15,
    ...
    {
      imageUrl: "https://media.istockphoto.com/id/1207734117/photo/climate-change-pollution-ice-melting-co2-and-waste-concept.webp?b=1&s=170667a&w=0&k=20&c=9mLhSb5ut-CQb7JUIxbpW2S0zX05coXq6yi4oloih_Y=",
      name: "Initiative 3",
      theme: "Theme 3",
      date: "2024-03-05",
      volunteers: 5,
    ...
    {
      imageUrl: "https://images.unsplash.com/photo-1565206595640-6cfd90e0ae09?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjN8fGVudmlyb25tZW50fGVufDB8fDB8fHww",
      name: "Initiative 4",
      theme: "Theme 4",
      date: "2024-09-05",
      volunteers: 21,
  ...
  return (
    <div
      style={{ backgroundColor: "#f0f2f5", display: "flex", height: "100%" }}
    >
      <div style={{ flex: "3", backgroundColor: "#f0f2f5", overflowY: "auto" }}>
        <h2 className="text-5xl font-semibold pt-5 mb-1 pl-5">
          Do something good today.
        </h2>
        <h2 className="text-md font-semibold pl-5 ">
          Volunteer for a programme in your area
        </h2>
        ...
        <div
          className="flex items-center justify-between px-4 py-2 bg-gray-300 mt-6"
          style={{ height: "200px", backgroundColor: "#F7B7A9" }}
        >
          <div>
            <h2 className="text-5xl font-semibold mt-5 mb-1">
              Don't wait for someone else.
            </h2>
            <h2 className="text-2xl font-semibold mb-5">
              Lead and start your own programme
            </h2>
          </div>
          <div className="pr-20 mr-20">
            <button className="px-4 py-2 bg-black text-white text-xl rounded-md">
              <a href="/start-program"> Start a Programme</a>
            ...
            <div className="mx-auto max-w-7xl px-2 lg:px-0">
              <div className="mx-auto max-w-4xl md:text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl text-gray-600 md:text-xl">
                  People share their valuable experiences with us on each of us
                  motivating us to participate in the same
                </p>
              </div>
                  ...
                  <div key={i} className="mx-auto w-[200px] rounded-md border">
                    ...
                    <div className="p-4">
                      ...
                      <p className="mt-3 text-sm text-gray-600">
                        Participated in tree plantation programme, it was
                        wonderful.
                      </p>
